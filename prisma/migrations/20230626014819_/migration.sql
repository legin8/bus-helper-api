...
CREATE TABLE "User" (
    ...
    "role" "Role" NOT NULL DEFAULT 'ADMIN_USER',
...
-- AddForeignKey
ALTER TABLE "TripSequence" ADD CONSTRAINT "TripSequence_tripId_fkey" FOREIGN KEY ("tripId") REFERENCES "Trip"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "SequenceStop" ADD CONSTRAINT "SequenceStop_serviceCode_version_fkey" FOREIGN KEY ("serviceCode", "version") REFERENCES "Sequence"("serviceCode", "version") ON DELETE RESTRICT ON UPDATE CASCADE;
